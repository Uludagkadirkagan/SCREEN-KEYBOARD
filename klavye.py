            ...
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                for i, box in enumerate(boxes):
                    ...
                    if in_box:
                        ...
                        if box_keys[i][0] not in {" ", "DEL",
                                                  "CLR"}:  # Do not add Space, Delete, and Clear keys to the text
                ...
                for i, box in enumerate(boxes):
                    ...
                    if last_box == i and box_keys[i][0] not in {" ", "DEL", "CLR"}:
                        cv2.putText(image, box_keys[i][current_key_index], (box[0] + 20, box[1] + 30),
                                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2, cv2.LINE_AA)
                    else:
                        for j, key in enumerate(box_keys[i]):
                            cv2.putText(image, key, (box[0] + 5, box[1] + 15 + j * 15), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
